...
# Identify numeric and categorical features for tourism dataset
numeric_features = [
    "Age",
...
# Calculate scale_pos_weight for XGBoost based on ytrain
class_weight = ytrain.value_counts()[0] / ytrain.value_counts()[1]
print(f"Calculated class_weight (negative_count / positive_count): {class_weight:.2f}")
...
with mlflow.start_run():
    ...
    model_path = "tourism_project/deployment/best_tourism_product_model_v1.joblib"
